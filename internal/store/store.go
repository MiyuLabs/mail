...
// GetThreadIDBySubject looks up a thread ID from a subject.
func (s *Store) GetThreadIDBySubject(ctx context.Context, subject string) (string, error) {
	return s.local.GetThreadIDBySubject(ctx, subject)
}
